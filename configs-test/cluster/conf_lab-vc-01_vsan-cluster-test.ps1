...
# ----------------------------------------
# vDS Settings
$vds_config = (Split-Path -Path $PSScriptRoot -Parent) + "/vds/conf_vds-05.ps1"
...
# ----------------------------------------
# vSAN Witness Config
$witness_config = (Split-Path -Path $PSScriptRoot -Parent) + "/witness/conf_Witness-VA_192.168.10.179.ps1"

...
task_message "Witness-3-02" "Add Witness Host: $vsan_witness_host_vcname"
Get-Datacenter $witness_dc | Add-VMHost -Name $vsan_witness_host_vcname -User $hv_user -Password $hv_pass -Force

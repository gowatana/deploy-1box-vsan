...
# Cluster setting
$nest_dc_name = "LAB-DC"
$nest_cluster_name = "vSAN-Cluster-20191219-AF"
$vm_num = 3
...
$vsan_capacity_disk_count = 3
$vsan_capacity_dev = "mpx.vmhba0:C0:T2:L0","mpx.vmhba0:C0:T3:L0","mpx.vmhba0:C0:T4:L0"

# Change ESXi Template VM
$template_vm_name = "vm-esxi-template-67u3"

# vSAN Datastore Name
$vsan_ds_name = "vsanDatastore-20191219-AF"

...
# Cluster setting
$nest_dc_name = "LAB-Site-B"
$nest_cluster_name = "vSAN-Cluster-20191225-Site-B"
$vm_num = 2
$hv_ip_4oct_start = 33 #ESXi-vmk0-IP 4 Octet
...
# vSAN Datastore Name
$vsan_ds_name = "vsanDatastore-20191225-SiteB"

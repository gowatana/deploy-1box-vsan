...
$env_config = "./configs/blog-2020-03/env_infra-vc-01.ps1"
...
$nest_cluster_name = "vSAN-Cluster-67u3"
$vm_num = 3
$hv_ip_4oct_start = 37 # 4th Octet for ESXi-vmk0-IP

# ----------------------------------------
# Nested ESXi settings

# ESXi Template VM
$template_vm_name = "esxi67u3-template-01"
...
# vSAN Datastore Name
$vsan_ds_name = "vsanDatastore-67u3"

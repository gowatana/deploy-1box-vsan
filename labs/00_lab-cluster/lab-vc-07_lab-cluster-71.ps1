...
$nest_vc_config = "$config_base/01_vcenter-login/lab-vc-07.ps1"

# Nest-vSphere environment config
$nest_env_config = "$config_base/03_nest-vsphere/lab-cluster-71.ps1"

# ----------------------------------------
# Additional configs

# vDS Settings
$vds_config = "$config_base/04_vds/lab-vds-01.ps1"

...
$vm_name_list | ForEach-Object {
    ...
    task_message "02-01-06" ("Set Memory size for Multi-DG: " + $vm_name)
    ...
    task_message "02-01-07" ("Start VM: " + $vm_name)
    $vm | Start-VM | ft -AutoSize Name,VMHost,PowerState
}

task_message "02-01-08" "waiting for VM startup."
...
task_message "02-01-09" "VM PowerOn Check"
...
task_message "02-01-10" "List ToolsStatus"
...
task_message "02-01-11" "Create VM Folder"
...
task_message "02-01-12" ("Move VM to Folder: " + $esxi_vm_folder_name)

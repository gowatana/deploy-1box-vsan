...
$vc_hv_name_list | % {
    ...
    task_message "03-01_01" ("Add ESXi to Cluster: " + $hv_name)
    ...
    task_message "03-01_02" ("Remove Default Local VMFS Datastore: " + $hv_name)
    Get-VMHost $hv_name | Remove-Datastore -Datastore "datastore*" -Confirm:$false -ErrorAction:Ignore
}

task_message "03-01_03" ("Set UserVars.SuppressShellWarning = 1")
